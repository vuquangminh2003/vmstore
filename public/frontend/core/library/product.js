(function($) {
 ...
 HT.popupSwiperSlide = () => {
  document.querySelectorAll(".popup-gallery").forEach(popup => {
    ...
    // Khởi tạo swiper thumbnail trước
    const swiperThumbs = new Swiper(popup.querySelector(".swiper-container-thumbs"), {
      slidesPerView: 6, // bạn có thể thay đổi số thumbnail
      spaceBetween: 10,
    ...
    // Khởi tạo swiper chính và gán thumbs
    const swiperMain = new Swiper(popup.querySelector(".swiper-container"), {
      loop: true,
      autoplay: {
        delay: 2000,
        disableOnInteraction: false,
