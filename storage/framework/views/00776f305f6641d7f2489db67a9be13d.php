<form action="<?php echo e(route('report.customer')); ?>" method="get">
                        ...
                        <?php if(count($reports)): ?>
                            ...
                            <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="table">
                                    ...
                                    ?>
                                    <td class="text-right"><?php echo e(round($rate,1).'%'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </tbody>
...
<?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/report/customer.blade.php ENDPATH**/ ?>