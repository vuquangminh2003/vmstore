<div id="header" class="pc-header uk-visible-large">
    ...
    <div class="middle">
        <div class="uk-container uk-container-center">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="logo">
                    <a href="/"><img src="<?php echo e($system['homepage_logo']); ?>" alt="Logo"></a>
                </div>
                <div class="header-search">
                    <form action="<?php echo e(write_url('tim-kiem')); ?>" class="uk-form form">
    ...
    <a href="<?php echo e(route('customer.profile')); ?>" class="cart-text">Tài khoản</a>
    
<?php else: ?>
    <a href="<?php echo e(route('fe.auth.login')); ?>" class="cart-text">Đăng nhập</a>
<?php endif; ?>
                ...
                <div class="header-toolbox">
                    <div class="uk-flex uk-flex-middle">
                        <div class="header-cart">
                            <div class="uk-flex uk-flex-middle">
                                <a href="<?php echo e(write_url('thanh-toan')); ?>" class="cart-text">Giỏ Hàng</a>
                                <div class="cart-mini">
                        ...
                        <div class="header-hotline">
                            ...
                            <div class="hotline-number"><?php echo e($system['contact_hotline']); ?></div>
                        </div>
            ...
            <div class="uk-grid uk-grid-medium uk-flex uk-flex-middle">
                <div class="uk-width-large-1-5">
                    ...
                    <div class="logoScroll">
                        <a href="" class="image img-cover"><img src="<?php echo e($system['homepage_logo']); ?>" alt=""></a>
                    </div>
                ...
                <div class="uk-width-large-4-5">
                    <?php echo $__env->make('frontend.component.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="uk-container uk-container-center">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="mobile-logo">
                    <a href="." title="<?php echo e($system['seo_meta_title']); ?>">
                        <img src="<?php echo e($system['homepage_logo']); ?>" alt="Mobile Logo">
                    </a>
                </div>
                <div class="mobile-widget">
                    <div class="uk-flex uk-flex-middle">
                        <a href="<?php echo e(write_url('thanh-toan')); ?>" class="btn btn-addCart">
...
<div id="mobileCanvas" class="uk-offcanvas offcanvas" >
    <div class="uk-offcanvas-bar" >
        <?php if(isset($menu['mobile'])): ?>
		<ul class="l1 uk-nav uk-nav-offcanvas uk-nav uk-nav-parent-icon" data-uk-nav>
			<?php $__currentLoopData = $menu['mobile']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $name = $val['item']->languages->first()->pivot->name;
                $canonical = write_url($val['item']->languages->first()->pivot->canonical, true, true);
            ?>
			<li class="l1 <?php echo e((count($val['children']))?'uk-parent uk-position-relative':''); ?>">
                <?php echo (isset($val['children']) && is_array($val['children']) && count($val['children']))?'<a href="#" title="" class="dropicon"></a>':''; ?>
				<a href="<?php echo e($canonical); ?>" title="<?php echo e($name); ?>" class="l1"><?php echo e($name); ?></a>
				<?php if(count($val['children'])): ?>
				<ul class="l2 uk-nav-sub">
					<?php $__currentLoopData = $val['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyItem => $valItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
					<li class="l2">
                        <a href="<?php echo e($canonical_2); ?>" title="<?php echo e($name_2); ?>" class="l2"><?php echo e($name_2); ?></a>
                    </li>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</ul>
				<?php endif; ?>
...
</div><?php /**PATH C:\xampp\htdocs\vmstore\resources\views/frontend/component/header.blade.php ENDPATH**/ ?>