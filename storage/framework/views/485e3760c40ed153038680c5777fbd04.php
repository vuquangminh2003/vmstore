...
<form action="<?php echo e(route('user.destroy', $user->id)); ?>" method="post" class="box">
    <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa thành viên có email là: <?php echo e($user->email); ?></p>
...
<?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/user/user/delete.blade.php ENDPATH**/ ?>