<form action="<?php echo e(route('language.index')); ?>">
        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <a href="<?php echo e(route('language.create')); ?>" class="btn btn-danger"><i class="fa fa-plus mr5"></i>Thêm mới ngôn ngữ</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/language/component/filter.blade.php ENDPATH**/ ?>