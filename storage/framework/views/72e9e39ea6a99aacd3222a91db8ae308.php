<form action="<?php echo e(route('report.product')); ?>" method="get">
    ...
    <?php
        $td = [ 'product_name', 'sum_qty','price_avg|format','sum_revenue|format', 'sum_discount|format'];
    ?>
...
<?php /**PATH C:\xampp\htdocs\vmstore\resources\views/backend/report/product.blade.php ENDPATH**/ ?>