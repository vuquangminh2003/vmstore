<form action="<?php echo e(route('widget.index')); ?>">
        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <a href="<?php echo e(route('widget.create')); ?>" class="btn btn-danger"><i class="fa fa-plus mr5"></i>Thêm mới widget</a>
                </div>
            </div>
        </div>
    </div>
</form><?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/widget/component/filter.blade.php ENDPATH**/ ?>