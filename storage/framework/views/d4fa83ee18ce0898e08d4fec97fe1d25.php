<div class="ibox">
    <div class="ibox-title">
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            <h5><?php echo e(__('messages.album.heading')); ?></h5>
            <div class="upload-album"><a href="" class="upload-picture"><?php echo e(__('messages.album.image')); ?></a></div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="click-to-upload">
                    ...
                    <div class="small-text"><?php echo e(__('messages.album.notice')); ?></div>
                </div>
                <?php endif; ?>
                
                <div class="upload-list <?php echo e((isset($gallery) && count($gallery)) ? '' : 'hidden'); ?>">
                    <ul id="sortable" class="clearfix data-album sortui ui-sortable">
                        <?php if(isset($gallery) && count($gallery)): ?>
                            <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="ui-state-default">
                                    <div class="thumb">
                                        <span class="span image img-scaledown">
                                            <img src="<?php echo e($val); ?>" alt="<?php echo e($val); ?>">
                                            <input type="hidden" name="album[]" value="<?php echo e($val); ?>">
                                        </span>
...
</div><?php /**PATH C:\xampp\htdocs\vmstore\resources\views/backend/dashboard/component/album.blade.php ENDPATH**/ ?>