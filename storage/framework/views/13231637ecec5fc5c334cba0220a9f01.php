                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="canonical"
                                        value="<?php echo e(old('canonical', ($language->canonical) ?? '' )); ?>"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="image"
                                        value="<?php echo e(old('image', ($language->image) ?? '' )); ?>"
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="description"
                                        value="<?php echo e(old('description', ($language->description) ?? '' )); ?>"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
...
<?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/language/store.blade.php ENDPATH**/ ?>