                                ...
                                <div class="form-row">
                                    ...
                                    <div class="code">
                                        <input 
                                            type="text"
                                            name="code"
                                            value="<?php echo e(old('code', ($customer->code) ?? time() )); ?>"
                                            class="form-control"
                                            placeholder=""
                                            autocomplete="off"
                                            readonly
                            ...
                            <div class="col-lg-6">
                                <div class="form-row customerWrapper">
                                    ...
                                    <select name="customer_catalogue_id" class="form-control setupSelect2">
                                        ...
                                        <?php $__currentLoopData = $customerCatalogues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e($item->id == old('customer_catalogue_id', (isset($customer->customer_catalogue_id)) ? $customer->customer_catalogue_id : '') ? 'selected' : ''); ?>  value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row customerWrapper">
                                    ...
                                    <select name="source_id" class="form-control setupSelect2">
                                        ...
                                        <option <?php echo e($val->id == old('source_id', (isset($customer->source_id)) ? $customer->source_id : '') ? 'selected' : ''); ?>  value="<?php echo e($val->id); ?>"><?php echo e($val->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="image"
                                        value="<?php echo e(old('image', ($customer->image) ?? '')); ?>"
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="date"
                                        name="birthday"
                                        value="<?php echo e(old('birthday', (isset($customer->birthday)) ? date('Y-m-d', strtotime($customer->birthday)) : '')); ?>"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="description"
                                        value="<?php echo e(old('description', ($customer->description) ?? '')); ?>"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
...
<script>
    var province_id = '<?php echo e((isset($customer->province_id)) ? $customer->province_id : old('province_id')); ?>'
    var district_id = '<?php echo e((isset($customer->district_id)) ? $customer->district_id : old('district_id')); ?>'
    var ward_id = '<?php echo e((isset($customer->ward_id)) ? $customer->ward_id : old('ward_id')); ?>'
</script><?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/customer/customer/store.blade.php ENDPATH**/ ?>