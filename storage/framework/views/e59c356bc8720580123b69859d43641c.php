<form action="<?php echo e(route('voucher.index')); ?>">
        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <a href="<?php echo e(route('voucher.create')); ?>" class="btn btn-danger"><i class="fa fa-plus mr5"></i>Thêm mới voucher</a>
                </div>
            </div>
        </div>
    </div>
</form><?php /**PATH C:\xampp\htdocs\vphome\resources\views/backend/voucher/component/filter.blade.php ENDPATH**/ ?>