        ...
        <div class="page-breadcrumb background">      
            <div class="uk-container uk-container-center">
                <ul class="uk-list uk-clearfix uk-flex uk-flex-middle">
                    ...
                    <li><a href="<?php echo e(route('buyer.profile')); ?>" title="">Danh sách đơn hàng</a></li>
                </ul>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        <?php if(isset($order) && count($order)): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="order-detail-link" href="<?php echo e(route('buyer.order.detail', ['id' => $val->id])); ?>"><?php echo e($val->code); ?></a></td>
...
<?php echo $__env->make('frontend.homepage.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vphome\resources\views/buyer/buyer/order.blade.php ENDPATH**/ ?>